...
<div id="problem_info" class="info">
 <h3>Problem 54</h3>
 <span>Published on Friday, 10th October 2003, 06:00 pm; Solved by 22404; Difficulty rating: 10%</span>
</div> 
   ...
   <tbody>
    ...
    <tr>
     ...
     <td>4D 6S 9H QH QC<br>
      <div class="note">
       Pair of Queens
       <br>Highest card Nine
      </div></td>
     <td>&nbsp;</td>
     <td>3D 6D 7H QD QS<br>
      <div class="note">
       Pair of Queens
       <br>Highest card Seven
      </div></td>
     <td>&nbsp;</td>
     <td style="vertical-align:top;">Player 1</td> 
    </tr>
