...
<div id="problem_info" class="info">
 <h3>Problem 57</h3>
 <span>Published on Friday, 21st November 2003, 06:00 pm; Solved by 26468; Difficulty rating: 5%</span>
</div> 
<div class="problem_content" role="problem"> 
 ...
 <p>1 + 1/2 = 3/2 = 1.5<br> 1 + 1/(2 + 1/2) = 7/5 = 1.4<br> 1 + 1/(2 + 1/(2 + 1/2)) = 17/12 = 1.41666...<br> 1 + 1/(2 + 1/(2 + 1/(2 + 1/2))) = 41/29 = 1.41379...<br></p> 
