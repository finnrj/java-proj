...
public class Problem032 {
	...
	public static void main(String[] args) {
		Predicate<String> oneTimesFourPandigital = str -> Integer.valueOf(str
				.substring(0, 1)) * Integer.valueOf(str.substring(1, 5)) == Integer
				.valueOf(str.substring(5));

		Predicate<String> twoTimesThreePandigital = str -> Integer.valueOf(str
				.substring(0, 2)) * Integer.valueOf(str.substring(2, 5)) == Integer
				.valueOf(str.substring(5));
